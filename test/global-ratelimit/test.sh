...
docker-compose -f $BASEDIR/ratelimit_server.yaml stop
docker-compose -f $BASEDIR/ratelimit_server.yaml kill
docker-compose -f $BASEDIR/ratelimit_server.yaml up -d
